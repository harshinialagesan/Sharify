...
// import 'package:my_app/token_service.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _loginUser() async{
    const String apiUrl = "http://localhost:8081/user/login";
    ...
    try{
      ...
      if (response.statusCode == 200) {
        ...
        _showErrorDialog(errorData['message'] ?? "An unexpected error occurred.");
      }
    }catch (e){
      setState(() {
        _isLoading = false;
